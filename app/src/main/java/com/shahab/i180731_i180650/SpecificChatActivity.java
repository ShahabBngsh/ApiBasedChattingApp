...
public class SpecificChatActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ls=new ArrayList<>();
        ls.add(new SpecificChatRVModel("Hey","i201550"));
        ls.add(new SpecificChatRVModel("Lets meet up at 8pm","i201550"));
        ls.add(new SpecificChatRVModel("LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM LOREM IPSUM","i201550"));
